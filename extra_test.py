...
path = '/app/MLP_ensemble_source/extra'
paser = InputParser()

test_data = paser.batch_parse(path)
# Step 1: 加载数据集并划分训练集和测试集
#traj_file = "/app/Data_HZO/dataset-6k-selected_20241209.traj"  # 替换为实际路径
#output_dir = "/app/Data_HZO/split"
...
# 保存结果
output_file = "/app/extra_predictions.csv"
